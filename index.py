...
def loadBankTemplates():
    ...
    time.sleep(1)
    session.findById("wnd[1]/usr/ctxtRLGRAP-FILENAME").text ="C:\\Users\\crist\\OneDrive - UNIVERSIDAD NACIONAL DE INGENIERIA\\Venado\\Cris\\auszug.txt"
    session.findById("wnd[1]/tbar[0]/btn[0]").press()
    time.sleep(1)
    session.findById("wnd[1]/usr/ctxtRLGRAP-FILENAME").text ="C:\\Users\\crist\\OneDrive - UNIVERSIDAD NACIONAL DE INGENIERIA\\Venado\\Cris\\umsatz.txt"
    session.findById("wnd[1]/tbar[0]/btn[0]").press()
    time.sleep(1)
    ...
    session.findById("wnd[0]/usr/ctxtAUSZFILE").text ="C:\\Users\\crist\\OneDrive - UNIVERSIDAD NACIONAL DE INGENIERIA\\Venado\\Cris\\auszug.txt"
    session.findById("wnd[0]/usr/ctxtUMSFILE").text ="C:\\Users\\crist\\OneDrive - UNIVERSIDAD NACIONAL DE INGENIERIA\\Venado\\Cris\\umsatz.txt"
