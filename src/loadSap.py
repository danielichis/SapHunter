...
def loadBankTemplates():
    ...
    path_xlsx=r"C:\Users\x11832\Documents\ProyectosDaniel\VENADO\sapHunter\SAPHunter\2984-21062022.xlsx"
    session.findById("wnd[0]/usr/ctxtARCHIVO").text = path_xlsx
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    time.sleep(1)
    session.findById("wnd[1]/tbar[0]/btn[8]").press()
    time.sleep(1)
    session.findById("wnd[1]/usr/ctxtRLGRAP-FILENAME").text =r"C:\Users\x11832\Documents\ProyectosDaniel\VENADO\sapHunter\SAPHunter\auszug.txt"
    session.findById("wnd[1]/tbar[0]/btn[0]").press()
    time.sleep(1)
    session.findById("wnd[1]/usr/ctxtRLGRAP-FILENAME").text =r"C:\Users\x11832\Documents\ProyectosDaniel\VENADO\sapHunter\SAPHunter\umsatz.txt"
    session.findById("wnd[1]/tbar[0]/btn[0]").press()
    time.sleep(1)
    ...
    session.findById("wnd[0]/usr/ctxtAUSZFILE").text =r"C:\Users\x11832\Documents\ProyectosDaniel\VENADO\sapHunter\SAPHunter\auszug.txt"
    session.findById("wnd[0]/usr/ctxtUMSFILE").text =r"C:\Users\x11832\Documents\ProyectosDaniel\VENADO\sapHunter\SAPHunter\umsatz.txt"
